...
export default function Philosophy() {
  ...
  const pillars = [
    {
      number: "01",
      title: t("pillar0Title"),
      summary: t("pillar0Summary"),
      points: [t("pillar0Point0"), t("pillar0Point1"), t("pillar0Point2")],
      accent: "bg-sage",
    },
    {
      number: "02",
      title: t("pillar1Title"),
      summary: t("pillar1Summary"),
      points: [t("pillar1Point0"), t("pillar1Point1"), t("pillar1Point2")],
      accent: "bg-terracotta",
    },
    {
      number: "03",
      title: t("pillar2Title"),
      summary: t("pillar2Summary"),
      points: [t("pillar2Point0"), t("pillar2Point1"), t("pillar2Point2")],
      accent: "bg-forest",
    },
  ];
          ...
          {pillars.map((pillar, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <span className={`w-2 h-2 rounded-full ${pillar.accent} opacity-40 group-hover:opacity-100 transition-opacity duration-500`} />
              </div>
              ...
              <ul className="space-y-3">
                {pillar.points.map((point, j) => (
                  ...
                  >
                    <span className={`w-1 h-1 rounded-full ${pillar.accent} mt-2 shrink-0 opacity-60`} />
              ...
              <div className="mt-8 overflow-hidden">
                ...
                >
                  ...
                  <svg className="w-3 h-3 text-terracotta -rotate-45" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <p className="font-sans text-[0.7rem] text-charcoal-light">
              {t("itiText")}{" "}
              <span className="text-forest font-medium">{t("itiName")}</span>{" "}
              {t("itiCountry")}
            </p>
          </div>
